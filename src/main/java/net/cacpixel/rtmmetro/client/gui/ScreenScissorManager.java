...
public class ScreenScissorManager
{
    ...
    public ScreenScissorManager(GuiScreenAdvanced screen)
    {
        this.screen = screen;
    }
    ...
    public ScissorParam pop()
    {
        ...
        {
            throw new RTMMetroException("ScreenScissorManager stack is empty, ScreenScissorManager.pop() too much!", e);
        }
    ...
    {
        if (!scissorStack.empty())
            throw new RTMMetroException("ScreenScissorManager stack is not empty, ScreenScissorManager.push() too much!");
    }
